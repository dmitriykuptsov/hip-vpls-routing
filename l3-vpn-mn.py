...
def run():
    ...
    info( net[ 'r2' ].cmd( 'ip route add 192.168.0.0/16 dev r2-tun1' ) )
    info( net[ 'r2' ].cmd( 'ip route add 192.168.0.0/16 dev r2-tun2' ) )
    info( net[ 'r2' ].cmd( 'ip route add 192.168.0.0/16 dev r2-tun3' ) )
    info( net[ 'r2' ].cmd( 'ip route add 192.168.0.0/16 dev r2-tun4' ) )

    info( net[ 'r3' ].cmd( 'ip route add 192.168.0.0/16 dev r3-tun1' ) )
    info( net[ 'r3' ].cmd( 'ip route add 192.168.0.0/16 dev r3-tun2' ) )
    info( net[ 'r3' ].cmd( 'ip route add 192.168.0.0/16 dev r3-tun3' ) )
    info( net[ 'r3' ].cmd( 'ip route add 192.168.0.0/16 dev r3-tun4' ) )

    info( net[ 'r4' ].cmd( 'ip route add 192.168.0.0/16 dev r4-tun1' ) )
    info( net[ 'r4' ].cmd( 'ip route add 192.168.0.0/16 dev r4-tun2' ) )
    info( net[ 'r4' ].cmd( 'ip route add 192.168.0.0/16 dev r4-tun3' ) )
    info( net[ 'r4' ].cmd( 'ip route add 192.168.0.0/16 dev r4-tun4' ) )
