...
def run():
    ...
    info( net[ 'r2' ].cmd( 'echo "1" > /proc/sys/net/ipv4/icmp_echo_ignore_all') )
    ...
    info( net[ 'r3' ].cmd( 'echo "1" > /proc/sys/net/ipv4/icmp_echo_ignore_all') )
    ...
    info( net[ 'r4' ].cmd( 'echo "1" > /proc/sys/net/ipv4/icmp_echo_ignore_all') )
